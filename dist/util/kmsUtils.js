...
exports.kmsCryptoDecrypt = exports.kmsCryptoEncrypt = void 0;
const logger_1 = require("./logger");
const kms_1 = __importDefault(require("@google-cloud/kms"));
require("dotenv").config();
const kms = new kms_1.default.v1.KeyManagementServiceClient();
...
const KMS_KEY_DEF = kms.cryptoKeyPath(PROJECT_ID, KMS_LOCATION, KMS_KEY_RING, KMS_KEY_NAME);
 ...
 */
async function kmsCryptoEncrypt(cc, mm, yyyy, name) {
    try {
        let plaintext = `${cc}`;
        if (mm && yyyy) {
        ...
        const buffer = result.ciphertext;
...
exports.kmsCryptoEncrypt = kmsCryptoEncrypt;
/**
 * Accepts the following params as an HTTP POST:
 *  project_id - The project ID associated with the auth_token
 ...
 *
 */
async function kmsCryptoDecrypt(ccToken) {
    try {
...
exports.kmsCryptoDecrypt = kmsCryptoDecrypt;

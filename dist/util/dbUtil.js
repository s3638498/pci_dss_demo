...
exports.insert = exports.updateCardData = exports.queryByPanHash = exports.queryByToken = exports.endTokenServer = exports.startTokenServer = void 0;
...
exports.startTokenServer = startTokenServer;
async function endTokenServer(currentClient) {
    try {
...
exports.endTokenServer = endTokenServer;
async function queryByToken(currentClient, token) {
...
exports.queryByToken = queryByToken;
async function queryByPanHash(currSess, panHash) {
...
exports.queryByPanHash = queryByPanHash;
async function updateCardData(currentClient, panHash, encryptedCardData) {
...
async function insert(currentClient, panHash, token, encryptedCardData) {
